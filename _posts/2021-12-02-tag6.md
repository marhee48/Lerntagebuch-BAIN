...
Mit marcEdit können Daten in verschiedenen Austauschformat (EAD, MarcXML) in ein einheitliches Datenformat überführt werden. Die nötigen Anpassungen der Felddaten (Bsp. Titel/Untertitel) wird mit der Skriptsprache XSLT ([Einfürhung](https://programminghistorian.org/en/lessons/transforming-xml-with-xsl) erreicht.
